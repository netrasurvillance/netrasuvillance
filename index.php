...
SOLUTIONS</title>
  ...
  <!-- Favicons -->
  <link href="assets/img/netra-logo.jpeg" rel="icon">
  <link href="assets/img/netra-logo.jpeg" rel="apple-touch-icon">
...
<!--         <h1><a href="index.html"><span>e</span>Startup</a></h1>
 -->        <!-- Uncomment below if you prefer to use an image logo -->
         <a href="index.html"><img src="assets/img/netra-logo.jpeg" height="100" width="100" class="img-fluid" alt="" title="" /></a>
      </div>
 ...
 <a href="#get-started" class="btn-get-started scrollto">Get Started</a>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-in">
      <h1>Easy to use, real-time &amp; <br/>robust computer vision on the edge</h1>
<!--       <h2>Easy to use, real-time &amp; robust computer vision on the edge</h2>
    ...
    <section id=" about-us" class="padd-section text-center">
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title text-center">
          ...
          <h1 class="section-heading">Unlock new opportunities with easy to use, real-time, robust computer vision on edge or cloud for your solutions</h1>
...
<!-- 
              ...
              <h4>EASY TO USE COMPUTER VISION</h4>
               </br>
              <p>We eliminate the complexity of computer vision by delivering ready to use models with APIs for your applications. We handle image processing and advanced math, customize the right combination of models, trackers, classifiers based on your application needs and deliver real computer vision, not demos.</p>
...
<!-- 
              ...
              <h4>ROBUST, OPTIMIZED MODELS</h4>
               </br>
              <p>We establish the desired trade-offs between accuracy and practicality for your application. The use of physics whenever possible and custom, optimized neural networks efficiently working with video pipeline designed for your use case brings your real-world computer vision applications to life. </p>
              </br>
              <a href="#">read more</a>
...
<!--               <img src="assets/img/svg/asteroid.svg" alt="img">
 -->              <h4>CLOUD AND EDGE (NVIDIA NANO)</h4>
                </br>
              <p>We deliver containerized solutions that run on AWS or SDKs on edge. We use specific algorithms and proprietary steps to maximize efficiency. Our models run on Nvidia Nano, a powerful sub $100 hardware, delivering privacy, low latency, real world use cases for mass market. </p>
              </br>
              <a href="#">read more</a>
   ...
   <!--  <section id="blog" class="padd-sectio">
    ...
    <section id="contact" class="padd-section">
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title text-center">
          <h2>Contact</h2>
          <p class="separator">Let's talk about your idea!</p>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-lg-12 text-center">
          <div class="footer-logo">
            ...
            <a class="navbar-brand" href="#">NETRA
SURVEILLANCE
SOLUTIONS</br>
<span style="font-size: 16px;">The Third Eye</span>
</a>

            <p class="footer-content">Join hands with NETRA to enter into the whole new
world of Artificial intelligence, where things are easier
Simpler yet more advanced. We offer you the best in
class services for making your life more safe , your
business more secure and work more productive.</p>
